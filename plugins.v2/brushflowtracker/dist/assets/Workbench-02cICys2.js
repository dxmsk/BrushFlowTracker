...
const _hoisted_6 = { class: "site-rail__head" };
const _hoisted_7 = { class: "site-list" };
const _hoisted_8 = ["onClick"];
const _hoisted_9 = { class: "workspace" };
const _hoisted_10 = { class: "site-head" };
const _hoisted_11 = { class: "site-head__name" };
const _hoisted_12 = { class: "site-head__actions" };
const _hoisted_13 = { class: "stats" };
const _hoisted_14 = { class: "panel__head" };
const _hoisted_15 = { class: "task-name" };
const _hoisted_16 = { class: "progress-cell" };
const _hoisted_17 = { class: "block-muted" };
const _hoisted_18 = { class: "block-muted" };
const _hoisted_19 = { class: "panel__head" };
const _hoisted_20 = {
  key: 0,
  class: "empty-state"
};
const _hoisted_21 = { class: "rule-title" };
const _hoisted_22 = { class: "rule-grid" };
const _hoisted_23 = { class: "rule-actions" };
const _hoisted_24 = { class: "panel__head" };
const _hoisted_25 = {
  key: 0,
  class: "empty-state"
};
...
const _hoisted_27 = { class: "order" };
const _hoisted_28 = { class: "cleanup-fields" };
const _hoisted_29 = { class: "vertical-actions" };
const _hoisted_30 = { class: "history-list" };
const _hoisted_31 = {
  key: 0,
  class: "empty-table"
};
const _hoisted_32 = { class: "settings-grid" };
const _hoisted_33 = { class: "settings-actions" };
const _hoisted_34 = {
  key: 1,
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
          ...
          _createVNode(_component_VSheet, {
            ...
            default: _withCtx(() => [
              _createElementVNode("div", _hoisted_6, [
                _cache[26] || (_cache[26] = _createElementVNode("strong", null, "站点", -1)),
                _createVNode(_component_VTooltip, { text: "新增站点" }, {
                  activator: _withCtx(({ props: tip }) => [
                    _createVNode(_component_VBtn, _mergeProps(tip, {
                      icon: "mdi-plus",
                      size: "small",
          ...
          _createElementVNode("main", _hoisted_9, [
            ...
            (selectedSite.value)
                    ...
                    default: _withCtx(() => [
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_13, [
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[33] || (_cache[33] = _createElementVNode("span", null, "托管任务", -1)),
                            ...
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[34] || (_cache[34] = _createElementVNode("span", null, "RSS 规则", -1)),
                            ...
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[35] || (_cache[35] = _createElementVNode("span", null, "最近读取", -1)),
                            ...
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[36] || (_cache[36] = _createElementVNode("span", null, "最近添加", -1)),
                            ...
                            default: _withCtx(() => [
                              _createElementVNode("header", _hoisted_14, [
                                _createElementVNode("div", null, [
                                  _cache[37] || (_cache[37] = _createElementVNode("h2", null, "qBittorrent 任务", -1)),
                                  _createElementVNode("p", null, _toDisplayString(draft.value.downloader || '尚未选择下载器'), 1)
                                ]),
                                _createElementVNode("div", null, [
                                  _createVNode(_component_VBtn, {
                                    variant: "tonal",
                              ...
                              _createVNode(_component_VDataTable, {
                                ...
                                "item.ratio": _withCtx(({ item }) => [
                                  ...
                                  _createElementVNode("small", _hoisted_17, _toDisplayString(formatDuration(item.seeding_time)), 1)
                                ]),
                                "item.speed": _withCtx(({ item }) => [
                                  _createElementVNode("span", null, "↓ " + _toDisplayString(formatBytes(item.dlspeed)) + "/s", 1),
                                  _createElementVNode("small", _hoisted_18, "↑ " + _toDisplayString(formatBytes(item.upspeed)) + "/s", 1)
                                ]),
                                ...
                                "no-data": _withCtx(() => [...(_cache[40] || (_cache[40] = [
                            ...
                            default: _withCtx(() => [
                              _createElementVNode("header", _hoisted_19, [
                                _cache[42] || (_cache[42] = _createElementVNode("div", null, [
                                  _createElementVNode("h2", null, "RSS 选种规则"),
                                  _createElementVNode("p", null, "规则未选择分辨率时才参与全局最高画质去重")
                                ], -1)),
                                _createVNode(_component_VBtn, {
                                  color: "primary",
                                  variant: "tonal",
                              ...
                              (!selectedSite.value.rss_rules.length)
                                ? (_openBlock(), _createElementBlock("div", _hoisted_20, [
                                    ...
                                    _cache[44] || (_cache[44] = _createElementVNode("strong", null, "尚未配置 RSS", -1)),
                                    _createVNode(_component_VBtn, {
                                      variant: "tonal",
                                      onClick: addRssRule
                                    }, {
                                            ...
                                            _createVNode(_component_VExpansionPanelTitle, null, {
                                              default: _withCtx(() => [
                                                _createElementVNode("div", _hoisted_21, [
                                                  ...
                                                  _createElementVNode("strong", null, _toDisplayString(rule.name || `RSS 规则 ${index + 1}`), 1),
                                                  _createVNode(_component_VChip, {
                                                    size: "x-small",
                                            ...
                                            _createVNode(_component_VExpansionPanelText, null, {
                                              default: _withCtx(() => [
                                                _createElementVNode("div", _hoisted_22, [
                                                  ...
                                                  _createVNode(_component_VTextField, {
                                                    modelValue: rule.max_age_minutes,
                                                    "onUpdate:modelValue": $event => ((rule.max_age_minutes) = $event),
                                                  ...
                                                  _createVNode(_component_VTextField, {
                                                    modelValue: rule.min_size_gib,
                                                    "onUpdate:modelValue": $event => ((rule.min_size_gib) = $event),
                                                    modelModifiers: { number: true },
                                                    type: "number",
                                                    min: "0",
                                                    step: "0.1",
                                                  ...
                                                  _createVNode(_component_VCombobox, {
                                                    modelValue: rule.tags,
                                                    "onUpdate:modelValue": $event => ((rule.tags) = $event),
                                                    class: "span-2",
                                                    label: "自动添加标签",
                                                    multiple: "",
                                                    chips: "",
                                                ...
                                                _createElementVNode("div", _hoisted_23, [
                                                  ...
                                                  _createVNode(_component_VBtn, {
                                                    ...
                                                    onClick: $event => (removeRule(selectedSite.value.rss_rules, index))
                                                  }, {
                            ...
                            default: _withCtx(() => [
                              ...
                              (!selectedSite.value.cleanup_rules.length)
                                ? (_openBlock(), _createElementBlock("div", _hoisted_25, [
                                    ...
                                    _cache[49] || (_cache[49] = _createElementVNode("strong", null, "尚未配置自动删种", -1)),
                                    _createVNode(_component_VBtn, {
                                      variant: "tonal",
                                      onClick: addCleanupRule
                                    }, {
                                ...
                                : (_openBlock(), _createElementBlock("div", _hoisted_26, [
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedSite.value.cleanup_rules, (rule, index) => {
                                      return (_openBlock(), _createBlock(_component_VSheet, {
                                        ...
                                        default: _withCtx(() => [
                                          _createElementVNode("div", _hoisted_27, _toDisplayString(index + 1), 1),
                      ...
                      _createVNode(_component_VWindowItem, { value: "history" }, {
                        default: _withCtx(() => [
                          _createVNode(_component_VSheet, { class: "panel app-surface-static" }, {
                            default: _withCtx(() => [
                              _cache[50] || (_cache[50] = _createElementVNode("header", { class: "panel__head" }, [
                                _createElementVNode("div", null, [
                                  _createElementVNode("h2", null, "处理记录"),
                                  _createElementVNode("p", null, "最近 100 条添加与删除结果")
                                ])
                              ], -1)),
                              _createElementVNode("div", _hoisted_30, [
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(status.value.history || [], (row) => {
                                  return (_openBlock(), _createElementBlock("article", {
                                    ...
                                    _createElementVNode("div", null, [
                                      _createElementVNode("strong", null, _toDisplayString(row.title), 1),
                                      _createElementVNode("span", null, _toDisplayString(row.reason || `${row.rule_name || 'RSS 规则'} · ${row.resolution || '未知画质'}`), 1)
                                    ]),
                                    _createElementVNode("time", null, _toDisplayString(formatTime(row.time)), 1)
                                  ]))
                                }), 128)),
                                (!status.value.history?.length)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_31, "暂无处理记录"))
                                  : _createCommentVNode("", true)
                              ])
                            ]),
                            _: 1
                      ...
                      _createVNode(_component_VWindowItem, { value: "settings" }, {
                        default: _withCtx(() => [
                          _createVNode(_component_VSheet, { class: "panel app-surface-static" }, {
                            default: _withCtx(() => [
                              _cache[53] || (_cache[53] = _createElementVNode("header", { class: "panel__head" }, [
                                _createElementVNode("div", null, [
                              ...
                              _createElementVNode("div", _hoisted_32, [
                                ...
                                _createVNode(_component_VSelect, {
                                  ...
                                  "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((draft.value.downloader) = $event)),
                                  class: "span-2",
                                ...
                                _createVNode(_component_VSwitch, {
                                  ...
                                  "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((draft.value.highest_resolution_dedup) = $event)),
                                  class: "span-2",
                                  label: "同一影视仅下载最高分辨率",
                                  color: "primary",
                                  "hide-details": "",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((draft.value.rss_interval_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "RSS 刷新间隔（分钟）",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((draft.value.free_monitor_interval_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "免费期检查间隔（分钟）",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((draft.value.cleanup_interval_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "自动删种间隔（分钟）",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((draft.value.request_timeout_seconds) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "5",
                                  max: "120",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((draft.value.history_limit) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "50",
                                  max: "5000",
                                ...
                                _createVNode(_component_VSwitch, {
                                  ...
                                  "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((selectedSite.value.use_proxy) = $event)),
                                  label: "当前站点 RSS 使用代理",
                                  "hide-details": "",
                                  inset: ""
                                }, null, 8, ["modelValue"]),
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((selectedSite.value.user_agent) = $event)),
                                  class: "span-2",
                              ...
                              _createElementVNode("div", _hoisted_33, [
                                ...
                                _createVNode(_component_VBtn, {
                                  ...
                                  loading: saving.value,
                                  onClick: _cache[20] || (_cache[20] = $event => (runOperation('free_monitor')))
                                }, {
              ...
              : (_openBlock(), _createElementBlock("div", _hoisted_34, [
                  ...
                  _cache[55] || (_cache[55] = _createElementVNode("strong", null, "还没有站点", -1)),
                  _createVNode(_component_VBtn, {
                    color: "primary",
                    variant: "flat",
                    "prepend-icon": "mdi-plus",
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((deleteSiteDialog).value = $event)),
      "max-width": "28rem"
    }, {
      default: _withCtx(() => [
          ...
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[22] || (_cache[22] = $event => (deleteSiteDialog.value = false))
                }, {
...
const Workbench = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a2dea74e"]]);
