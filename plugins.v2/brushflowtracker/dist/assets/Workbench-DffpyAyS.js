...
const _hoisted_23 = { class: "range-fields range-fields--units" };
const _hoisted_24 = { class: "value-unit" };
const _hoisted_25 = { class: "value-unit" };
const _hoisted_26 = { class: "range-control" };
const _hoisted_27 = { class: "range-fields range-fields--units" };
const _hoisted_28 = { class: "value-unit" };
const _hoisted_29 = { class: "value-unit" };
const _hoisted_30 = { class: "rule-actions" };
const _hoisted_31 = { class: "panel__head" };
const _hoisted_32 = {
  key: 0,
  class: "empty-state"
};
...
const _hoisted_34 = { class: "order" };
const _hoisted_35 = { class: "cleanup-fields" };
const _hoisted_36 = { class: "vertical-actions" };
const _hoisted_37 = { class: "history-list" };
const _hoisted_38 = ["href"];
const _hoisted_39 = { key: 1 };
const _hoisted_40 = { class: "history-result" };
...
const _hoisted_44 = { class: "settings-grid" };
const _hoisted_45 = { class: "settings-actions" };
const _hoisted_46 = {
  key: 1,
  class: "empty-state empty-workspace"
};
const _hoisted_47 = { class: "rule-grid auth-grid" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
    ...
    (loading.value && !sites.value.length)
      ...
      : (_openBlock(), _createElementBlock("div", _hoisted_5, [
          _createVNode(_component_VSheet, {
            ...
            default: _withCtx(() => [
              _cache[49] || (_cache[49] = _createElementVNode("div", { class: "site-rail__head" }, [
              ...
              _createElementVNode("div", _hoisted_6, [
                ...
                _createElementVNode("button", {
                  ...
                  _createElementVNode("span", null, [
                    ...
                    _cache[47] || (_cache[47] = _createTextVNode("新增站点", -1))
                  ]),
                  _cache[48] || (_cache[48] = _createElementVNode("small", null, "创建新的站点配置", -1))
                ])
              ])
            ]),
            _: 1
          ...
          _createElementVNode("main", _hoisted_8, [
            ...
            (selectedSite.value)
                    ...
                    default: _withCtx(() => [
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_12, [
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[55] || (_cache[55] = _createElementVNode("span", null, "托管任务", -1)),
                            ...
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[56] || (_cache[56] = _createElementVNode("span", null, "RSS 任务", -1)),
                            ...
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[57] || (_cache[57] = _createElementVNode("span", null, "最近读取", -1)),
                            ...
                            _createVNode(_component_VSheet, { class: "stat app-surface-static" }, {
                              default: _withCtx(() => [
                                _cache[58] || (_cache[58] = _createElementVNode("span", null, "最近添加", -1)),
                            ...
                            default: _withCtx(() => [
                              _createElementVNode("header", _hoisted_13, [
                                _createElementVNode("div", null, [
                                  _cache[59] || (_cache[59] = _createElementVNode("h2", null, "本插件托管的 qBittorrent 任务", -1)),
                            ...
                            default: _withCtx(() => [
                              ...
                              (!selectedSite.value.rss_rules.length)
                                ? (_openBlock(), _createElementBlock("div", _hoisted_19, [
                                    ...
                                    _cache[66] || (_cache[66] = _createElementVNode("strong", null, "尚未配置 RSS 任务", -1)),
                                    _createVNode(_component_VBtn, {
                                      variant: "tonal",
                                      onClick: addRssRule
                                    }, {
                                              ...
                                              default: _withCtx(() => [
                                                _createElementVNode("div", _hoisted_21, [
                                                  ...
                                                  _createVNode(_component_VCombobox, {
                                                    modelValue: rule.whitelist_keywords,
                                                    "onUpdate:modelValue": $event => ((rule.whitelist_keywords) = $event),
                                                    label: "白名单关键词（必须全部包含）",
                                                    multiple: "",
                                                    chips: "",
                                                    "closable-chips": "",
                                                  ...
                                                  _createVNode(_component_VCombobox, {
                                                    modelValue: rule.blacklist_keywords,
                                                    "onUpdate:modelValue": $event => ((rule.blacklist_keywords) = $event),
                                                    label: "黑名单关键词（命中任一个即排除）",
                                                    multiple: "",
                                                    chips: "",
                                                    "closable-chips": "",
                                                    "hide-details": ""
                                                  ...
                                                  _createElementVNode("div", _hoisted_22, [
                                                    _cache[68] || (_cache[68] = _createElementVNode("span", null, "发种时间范围", -1)),
                                                    _createElementVNode("div", _hoisted_23, [
                                                      _createElementVNode("div", _hoisted_24, [
                                                        _createVNode(_component_VTextField, {
                                                          modelValue: rule.publish_age_from_value,
                                                          "onUpdate:modelValue": $event => ((rule.publish_age_from_value) = $event),
                                                        ...
                                                        _createVNode(_component_VSelect, {
                                                          modelValue: rule.publish_age_from_unit,
                                                          "onUpdate:modelValue": $event => ((rule.publish_age_from_unit) = $event),
                                                          items: timeUnitOptions,
                                                          "aria-label": "起始时间单位",
                                                          "hide-details": ""
                                                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                                                      ]),
                                                      _cache[67] || (_cache[67] = _createElementVNode("b", null, "至", -1)),
                                                      _createElementVNode("div", _hoisted_25, [
                                                        _createVNode(_component_VTextField, {
                                                          modelValue: rule.publish_age_to_value,
                                                          "onUpdate:modelValue": $event => ((rule.publish_age_to_value) = $event),
                                                          modelModifiers: { number: true },
                                                          type: "number",
                                                          min: "0",
                                                          label: "到",
                                                        ...
                                                        _createVNode(_component_VSelect, {
                                                          modelValue: rule.publish_age_to_unit,
                                                          "onUpdate:modelValue": $event => ((rule.publish_age_to_unit) = $event),
                                                          items: timeUnitOptions,
                                                          "aria-label": "结束时间单位",
                                                          "hide-details": ""
                                                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                                                  ...
                                                  _createElementVNode("div", _hoisted_26, [
                                                    _cache[70] || (_cache[70] = _createElementVNode("span", null, "种子大小范围", -1)),
                                                    _createElementVNode("div", _hoisted_27, [
                                                      _createElementVNode("div", _hoisted_28, [
                                                        _createVNode(_component_VTextField, {
                                                          modelValue: rule.size_from_value,
                                                          "onUpdate:modelValue": $event => ((rule.size_from_value) = $event),
                                                          modelModifiers: { number: true },
                                                          type: "number",
                                                          min: "0",
                                                          step: "0.1",
                                                        ...
                                                        _createVNode(_component_VSelect, {
                                                          modelValue: rule.size_from_unit,
                                                          "onUpdate:modelValue": $event => ((rule.size_from_unit) = $event),
                                                          items: sizeUnitOptions,
                                                          "aria-label": "起始体积单位",
                                                          "hide-details": ""
                                                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                                                      ]),
                                                      _cache[69] || (_cache[69] = _createElementVNode("b", null, "至", -1)),
                                                      _createElementVNode("div", _hoisted_29, [
                                                        _createVNode(_component_VTextField, {
                                                          modelValue: rule.size_to_value,
                                                          "onUpdate:modelValue": $event => ((rule.size_to_value) = $event),
                                                          modelModifiers: { number: true },
                                                          type: "number",
                                                          min: "0",
                                                          step: "0.1",
                                                        ...
                                                        _createVNode(_component_VSelect, {
                                                          modelValue: rule.size_to_unit,
                                                          "onUpdate:modelValue": $event => ((rule.size_to_unit) = $event),
                                                          items: sizeUnitOptions,
                                                          "aria-label": "结束体积单位",
                                                          "hide-details": ""
                                                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                            ...
                            default: _withCtx(() => [
                              ...
                              (!selectedSite.value.cleanup_rules.length)
                                ? (_openBlock(), _createElementBlock("div", _hoisted_32, [
                                    ...
                                    _cache[76] || (_cache[76] = _createElementVNode("strong", null, "尚未配置自动删种", -1)),
                                    _createVNode(_component_VBtn, {
                                      variant: "tonal",
                                      onClick: addCleanupRule
                                    }, {
                                ...
                                : (_openBlock(), _createElementBlock("div", _hoisted_33, [
                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedSite.value.cleanup_rules, (rule, index) => {
                                      return (_openBlock(), _createBlock(_component_VSheet, {
                                        ...
                                        default: _withCtx(() => [
                                          _createElementVNode("div", _hoisted_34, _toDisplayString(index + 1), 1),
                      ...
                      _createVNode(_component_VWindowItem, { value: "history" }, {
                        default: _withCtx(() => [
                          _createVNode(_component_VSheet, { class: "panel app-surface-static" }, {
                            default: _withCtx(() => [
                              _cache[79] || (_cache[79] = _createElementVNode("header", { class: "panel__head" }, [
                                _createElementVNode("div", null, [
                                  _createElementVNode("h2", null, "处理记录"),
                                  _createElementVNode("p", null, "对比每个种子的规则条件与实际检测结果；点击名称进入种子页面")
                                ])
                              ], -1)),
                              _createElementVNode("div", _hoisted_37, [
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(status.value.history || [], (row) => {
                                  return (_openBlock(), _createElementBlock("article", {
                                    key: `${row.time}-${row.title}-${row.outcome}`
                                  }, [
                                    _createVNode(_component_VIcon, {
                                      icon: historyIcon(row),
                                      color: historyColor(row)
                                    }, null, 8, ["icon", "color"]),
                                    _createElementVNode("div", null, [
                                      (row.link)
                                        ? (_openBlock(), _createElementBlock("a", {
                                          ...
                                          }, _toDisplayString(row.title), 9, _hoisted_38))
                                        : (_openBlock(), _createElementBlock("strong", _hoisted_39, _toDisplayString(row.title), 1)),
                                      _createElementVNode("span", _hoisted_40, _toDisplayString(historyMeta(row)), 1),
                                      (row.rule_summary)
                                        ? (_openBlock(), _createElementBlock("span", _hoisted_41, [
                                            _cache[77] || (_cache[77] = _createElementVNode("b", null, "规则条件：", -1)),
                                            _createTextVNode(_toDisplayString(row.rule_summary), 1)
                                          ]))
                                        : _createCommentVNode("", true),
                                      (row.actual_summary)
                                        ? (_openBlock(), _createElementBlock("span", _hoisted_42, [
                                            _cache[78] || (_cache[78] = _createElementVNode("b", null, "实际检测：", -1)),
                                            _createTextVNode(_toDisplayString(row.actual_summary), 1)
                                          ]))
                                        : _createCommentVNode("", true)
                                    ]),
                      ...
                      _createVNode(_component_VWindowItem, { value: "settings" }, {
                        default: _withCtx(() => [
                          _createVNode(_component_VSheet, { class: "panel app-surface-static" }, {
                            default: _withCtx(() => [
                              _cache[83] || (_cache[83] = _createElementVNode("header", { class: "panel__head" }, [
                                _createElementVNode("div", null, [
                              ...
                              _createElementVNode("div", _hoisted_44, [
                                ...
                                _createVNode(_component_VSwitch, {
                                  ...
                                  class: "span-2",
                                  label: "所有站点同一资源只保留最佳画质，同画质保留最大体积",
                                  color: "primary",
                                  "hide-details": "",
                                  inset: ""
                                }, null, 8, ["modelValue"]),
                                _createVNode(_component_VSwitch, {
                                  modelValue: draft.value.avoid_dead_seeds,
                                  "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((draft.value.avoid_dead_seeds) = $event)),
                                  class: "span-2",
                                  label: "避开无做种死种并自动切换可下载版本",
                                  color: "warning",
                                  "hide-details": "",
                                  inset: ""
                                }, null, 8, ["modelValue"]),
                                _createVNode(_component_VTextField, {
                                  modelValue: draft.value.dead_seed_wait_minutes,
                                  "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((draft.value.dead_seed_wait_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "死种等待时间",
                                ...
                                _createVNode(_component_VTextField, {
                                  modelValue: draft.value.dead_seed_min_seeders,
                                  "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((draft.value.dead_seed_min_seeders) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "0",
                                  label: "最低做种数",
                                ...
                                _createVNode(_component_VSwitch, {
                                  modelValue: draft.value.dead_seed_delete_files,
                                  "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((draft.value.dead_seed_delete_files) = $event)),
                                  label: "死种删除文件",
                                  color: "error",
                                  "hide-details": "",
                                  inset: ""
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((draft.value.rss_interval_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "RSS 刷新间隔（分钟）",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((draft.value.free_monitor_interval_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "免费期检查间隔（分钟）",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[24] || (_cache[24] = $event => ((draft.value.cleanup_interval_minutes) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "1",
                                  label: "自动删种间隔（分钟）",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[25] || (_cache[25] = $event => ((draft.value.request_timeout_seconds) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "5",
                                  max: "120",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[26] || (_cache[26] = $event => ((draft.value.history_limit) = $event)),
                                  modelModifiers: { number: true },
                                  type: "number",
                                  min: "50",
                                  max: "5000",
                                ...
                                _createVNode(_component_VSwitch, {
                                  ...
                                  "onUpdate:modelValue": _cache[27] || (_cache[27] = $event => ((selectedSite.value.use_proxy) = $event)),
                                  label: "当前站点 RSS 使用代理",
                                  "hide-details": "",
                                  inset: ""
                                }, null, 8, ["modelValue"]),
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[28] || (_cache[28] = $event => ((selectedSite.value.user_agent) = $event)),
                                  class: "span-2",
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((selectedSite.value.uid) = $event)),
                                  label: "站点 UID（可选）",
                                  hint: "会自动补到 RSS/详情地址",
                                  "persistent-hint": "",
                                  "hide-details": "auto"
                                ...
                                _createVNode(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[30] || (_cache[30] = $event => ((selectedSite.value.passkey) = $event)),
                                  label: "站点 Passkey（可选）",
                              ...
                              _createElementVNode("div", _hoisted_45, [
                                ...
                                _createVNode(_component_VBtn, {
                                  ...
                                  loading: saving.value,
                                  onClick: _cache[31] || (_cache[31] = $event => (runOperation('free_monitor')))
                                }, {
              ...
              : (_openBlock(), _createElementBlock("div", _hoisted_46, [
                  ...
                  _cache[85] || (_cache[85] = _createElementVNode("strong", null, "还没有站点", -1)),
                  _createVNode(_component_VBtn, {
                    color: "primary",
                    variant: "flat",
                    "prepend-icon": "mdi-plus",
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[42] || (_cache[42] = $event => ((authDialog).value = $event)),
      "max-width": "52rem",
      scrollable: ""
    }, {
      default: _withCtx(() => [
          ...
          ? (_openBlock(), _createBlock(_component_VCard, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    _cache[87] || (_cache[87] = _createElementVNode("p", { class: "block-muted auth-help" }, "此页面只作用于当前 RSS 任务。任务级填写优先于站点默认值；留空则继承站点设置或 MoviePilot 站点 Cookie。", -1)),
                    _createElementVNode("div", _hoisted_47, [
                      _createVNode(_component_VTextField, {
                        modelValue: authRule.value.uid,
                        "onUpdate:modelValue": _cache[33] || (_cache[33] = $event => ((authRule.value.uid) = $event)),
                        label: "UID",
                      ...
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((authRule.value.passkey) = $event)),
                        label: "Passkey",
                        type: "password",
                      ...
                      _createVNode(_component_VTextField, {
                        modelValue: authRule.value.rss_key,
                        "onUpdate:modelValue": _cache[35] || (_cache[35] = $event => ((authRule.value.rss_key) = $event)),
                        label: "RSS 密钥",
                        type: "password",
                        placeholder: "站点提供的 RSS Key",
                        "hide-details": ""
                      }, null, 8, ["modelValue"]),
                      _createVNode(_component_VTextField, {
                        modelValue: authRule.value.rss_key_name,
                        "onUpdate:modelValue": _cache[36] || (_cache[36] = $event => ((authRule.value.rss_key_name) = $event)),
                        label: "RSS 密钥参数名",
                        placeholder: "默认 rsskey，也可能是 authkey",
                        "hide-details": ""
                      }, null, 8, ["modelValue"]),
                      _createVNode(_component_VTextarea, {
                        modelValue: authRule.value.cookie,
                        "onUpdate:modelValue": _cache[37] || (_cache[37] = $event => ((authRule.value.cookie) = $event)),
                        class: "span-2",
                        label: "Cookie（可选）",
                      ...
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[38] || (_cache[38] = $event => ((authRule.value.user_agent) = $event)),
                        label: "User-Agent（可选）",
                      ...
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[39] || (_cache[39] = $event => ((authRule.value.referer) = $event)),
                        label: "Referer（可选）",
                      ...
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[40] || (_cache[40] = $event => ((authRule.value.use_proxy) = $event)),
                ...
                _createVNode(_component_VCardActions, null, {
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_VBtn, {
                      variant: "text",
                      onClick: _cache[41] || (_cache[41] = $event => (authRule.value = null))
                    }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[44] || (_cache[44] = $event => ((deleteSiteDialog).value = $event)),
      "max-width": "28rem"
    }, {
      default: _withCtx(() => [
          ...
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[43] || (_cache[43] = $event => (deleteSiteDialog.value = false))
                }, {
...
const Workbench = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-367a8a45"]]);
